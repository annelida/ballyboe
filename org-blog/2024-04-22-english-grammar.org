...
/Relative pronouns/ are words that introduce relative clauses, which
provide additional information about a noun or noun phrase in a
sentence.
...
They provide information about which or how many things the noun
refers to. Determiners are essential in making the meaning of a
sentence clear by indicating specifics such as definiteness, quantity,
possession, and more.

** Specific and general determiners

/Specific determiners/ in English are words that point to specific
nouns that are already known to the listener or reader.
...
To make questions, we often put the verb before the subject. This is
called inversion.
...
If there is a question word (why, what, where, how, etc.), it goes
before the verb.
...
For other verbs in the present simple, we use the auxiliary verb
=do/does= in the question.
 ...
 They went to the  Did they go to the  Where did they go?
 cinema.   cinema?
